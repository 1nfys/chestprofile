...
мод на майнкрафт, который раскладывает вещи по сундукам по готовым разметкам. настрой профиль с предметами, и он сам перенесет нужное количество из инвентаря. призрачные иконки показывают, что куда должно лечь.
...
- в профиле лежит набор предметов с количеством. по сути, это разметка сундука
- призрачные предметы. даже в пустом сундуке видно, где и что должно лежать
- автозаполнение. переносит из инвентаря ровно столько, сколько нужно по разметке
...
- конструктор разметок открывается прямо из меню
- хоткеи на перенос и на скрытие панели
- лок слотов. зажми alt и кликни по слоту сундука или инвентаря - слот заблокируется фиолетовой рамкой и не будет переноситься. нажми еще раз, чтобы разблокировать
...
| **панель и призраки.** открой сундук и слева появится панель с конфигами и профилями. листай конфиги стрелками или скроллом, выбирай профиль | **автозаполнение.** выбери профиль и нажми кнопку заполнения предметы из инвентаря переносятся по разметке |
...
2. в настройках (шестеренка на панели) нажми конструктор разметки - откроется удобный сайт
3. собери разметку, добавляя предметы
...
- разметка считается по количеству предметов в инвентаре и сундуке. сколько стаков, столько слотов и занимает
